...
1. [技術設計](./design.md)
1. [Chrome 拡張機能仕様](./chrome-extension/README.md)
...
- 拡張機能は `chrome-extension/` 配下にある Manifest V3 のブラウザ拡張である
- ポップアップ UI から現在タブのタイトルと URL を取り込み、API サーバーへブックマークを送信する
- API 接続確認、既存ブックマークの読み込み、削除もポップアップから行える
- 設計や申請文面を更新する場合は、拡張機能の仕様も `specs/chrome-extension/` に反映する
...
- [拡張機能仕様](./chrome-extension/README.md)
