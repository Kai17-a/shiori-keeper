      ...
      <div class="space-y-6">
        ...
        >
          <UAlert
            ...
            description="A working LLM connection is required before a custom news site can be registered."
            color="warning"
            variant="soft"
          />
...
const llmApiKeyDescription = computed(() =>
  llmSettings.value?.api_key_configured
    ...
    : "Optional for Ollama, vLLM, and compatible servers that do not require authentication.",
);
...
const loadLlmSettings = async () => {
  ...
  try {
    ...
    llmForm.provider = response.provider;
